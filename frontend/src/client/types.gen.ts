...
export type BlocosValeGasPublic = {
    data: Array<BlocoValeGasPublic>;
};
...
export type BlocoValeGasCreate = {
    cliente_id: string;
    primeira_folha: number;
    ultima_folha: number;
    data: string;
...
export type BlocoValeGasPublic = {
    id: string;
    cliente_id: string;
    cliente_nome: string;
    cliente_cpf: string;
...
export type CascoItemCreate = {
    produto_id: string;
    quantidade: number;
};

export type CascosClientePublic = {
    cliente_id: string;
    total_cascos_abertos: number;
    cascos: Array<EmprestimoCascoPublic>;
};
...
export type ClientesFiadoPublic = {
    data: Array<ClienteFiadoPublic>;
    count: number;
};
...
export type EmprestimoCascoConfirmarRequest = {
    observacao?: (string | null);
};

export type EmprestimoCascoDesfazerRequest = {
    observacao?: (string | null);
};

export type EmprestimoCascoLogPublic = {
    id: string;
    evento: string;
...
export type EmprestimoCascoPublic = {
    ...
    status: string;
    logs?: Array<EmprestimoCascoLogPublic>;
    created_at: string;
};

export type EmprestimoCascoReceberRequest = {
    observacao?: (string | null);
};

export type EmprestimosCascoPublic = {
    data: Array<EmprestimoCascoPublic>;
    count: number;
    total_cascos_abertos: number;
};
...
export type GasPovoRecebimentoPublic = {
    pendentes: Array<GasPovoVendaPublic>;
...
export type GasPovoVendaPublic = {
    id: string;
    cliente_id: string;
    cliente_nome: string;
    motorista_nome: string;
    ...
    gas_povo_frete_recebido_em: string;
    data_venda: string;
    pago_em?: (string | null);
    dias_em_aberto: number;
};
...
export type MotoristaFcmTokenUpdate = {
    fcm_token: string;
};
...
export type PrecoCreate = {
    valor: (number | string);
    preco_casco?: (number | string | null);
};

export type PrecoPublic = {
    id: string;
    valor: string;
    preco_casco?: (string | null);
    valid_from: string;
};
...
export type VendaEstornarRequest = {
    valor_estorno: (number | string);
};
...
export type VendaItemPublic = {
    ...
    subtotal: string;
    com_casco?: boolean;
    preco_casco_snapshot?: (string | null);
};
...
export type VendaPagamentoEstornarRequest = {
    valor_estorno: (number | string);
};
...
export type VendaPublic = {
    ...
    cascos_emprestados?: Array<EmprestimoCascoPublic>;
};
...
export type CascosListarCascosEmAbertoResponse = (EmprestimosCascoPublic);

export type CascosListarAguardandoConfirmacaoResponse = (EmprestimosCascoPublic);

export type CascosListarHistoricoResponse = (EmprestimosCascoPublic);

export type CascosCascosPorClienteData = {
    clienteId: string;
};

export type CascosCascosPorClienteResponse = (CascosClientePublic);

export type CascosCascosPorVendaData = {
    vendaId: string;
};

export type CascosCascosPorVendaResponse = (EmprestimosCascoPublic);

export type CascosReceberCascoData = {
    cascoId: string;
    requestBody: EmprestimoCascoReceberRequest;
};

export type CascosReceberCascoResponse = (EmprestimoCascoPublic);

export type CascosConfirmarDevolucaoCascoData = {
    cascoId: string;
    requestBody: EmprestimoCascoConfirmarRequest;
};

export type CascosConfirmarDevolucaoCascoResponse = (EmprestimoCascoPublic);

export type CascosDesfazerRecebimentoCascoData = {
    cascoId: string;
    requestBody: EmprestimoCascoDesfazerRequest;
};

export type CascosDesfazerRecebimentoCascoResponse = (EmprestimoCascoPublic);

export type CascosDesfazerConfirmacaoCascoData = {
    cascoId: string;
    requestBody: EmprestimoCascoDesfazerRequest;
};

export type CascosDesfazerConfirmacaoCascoResponse = (EmprestimoCascoPublic);
...
export type DelegacaoAtualizarFcmTokenMotoristaData = {
    motoristaId: string;
    requestBody: MotoristaFcmTokenUpdate;
};

export type DelegacaoAtualizarFcmTokenMotoristaResponse = (Message);

export type FechamentoReadStatusAberturaData = {
    data: string;
};

export type FechamentoReadStatusAberturaResponse = (unknown);

export type FechamentoReadAberturaProdutosData = {
    aberturaId: string;
};

export type FechamentoReadAberturaProdutosResponse = (unknown);

export type FechamentoCriarAberturaData = {
    requestBody: {
        [key: string]: unknown;
    };
};

export type FechamentoCriarAberturaResponse = (unknown);

export type FechamentoEditarAberturaData = {
    aberturaId: string;
    requestBody: {
        [key: string]: unknown;
    };
...
export type FechamentoEditarAberturaResponse = (unknown);

export type FechamentoVerificarSenhaGerenteData = {
    requestBody: {
        [key: string]: unknown;
    };
};

export type FechamentoVerificarSenhaGerenteResponse = (unknown);

export type FechamentoReadResumoFechamentoData = {
    data: string;
    motoristaId: string;
};

export type FechamentoReadResumoFechamentoResponse = (unknown);

export type FechamentoFecharDiaData = {
    requestBody: {
        [key: string]: unknown;
    };
};

export type FechamentoFecharDiaResponse = (unknown);

export type FechamentoReadDashboardData = {
    periodo?: string;
};

export type FechamentoReadDashboardResponse = (unknown);

export type GasPovoReadRecebimentoGasPovoResponse = (GasPovoRecebimentoPublic);

export type GasPovoMarcarGasPovoRecebidoData = {
    vendaId: string;
};

export type GasPovoMarcarGasPovoRecebidoResponse = (VendaPublic);
...
export type ValeGasReadBlocosValeGasResponse = (BlocosValeGasPublic);

export type ValeGasCreateBlocoValeGasData = {
    requestBody: BlocoValeGasCreate;
};

export type ValeGasCreateBlocoValeGasResponse = (BlocoValeGasPublic);

export type ValeGasBuscarClienteValeGasData = {
    q: string;
};

export type ValeGasBuscarClienteValeGasResponse = (Array<{
    [key: string]: unknown;
}>);

export type ValeGasValidarNumeroValeGasData = {
    numero: number;
};

export type ValeGasValidarNumeroValeGasResponse = ({
    [key: string]: unknown;
});

export type ValeGasReadRecebimentoResumoResponse = (Array<{
    [key: string]: unknown;
}>);

export type ValeGasReadFolhasBlocoData = {
    blocoId: string;
};

export type ValeGasReadFolhasBlocoResponse = (Array<{
    [key: string]: unknown;
}>);

export type ValeGasMarcarFolhaRecebidaData = {
    vendaId: string;
};

export type ValeGasMarcarFolhaRecebidaResponse = ({
    [key: string]: unknown;
});
...
export type VendasBaixarPagamentoMixData = {
    id: string;
    pagamentoId: string;
    requestBody: VendaPagamentoBaixarRequest;
};

export type VendasBaixarPagamentoMixResponse = (VendaPublic);

export type VendasEstornarPagamentoMixData = {
    id: string;
    pagamentoId: string;
    requestBody: VendaPagamentoEstornarRequest;
};

export type VendasEstornarPagamentoMixResponse = (VendaPublic);

export type VendasEstornarRecebimentoLegadoData = {
    id: string;
    requestBody: VendaEstornarRequest;
};

export type VendasEstornarRecebimentoLegadoResponse = (VendaPublic);

export type VendasEditarVendaData = {
    id: string;
    requestBody: VendaEditarRequest;
};

export type VendasEditarVendaResponse = (VendaPublic);

export type VendasCancelarVendaData = {
    id: string;
};
