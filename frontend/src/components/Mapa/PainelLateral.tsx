// [mcp-local harness] feature: painel-mapa-frontend | plano: 660739b7 | 2026-08-07 09:41:31
// Painel lateral: reservado + Ranking da Semana + Chamadas hoje
...
function BlocoReservado() {
  return (
    <div className="flex h-28 shrink-0 items-center justify-center rounded-lg border bg-card text-xs text-muted-foreground">
      ...
      <div className="grid grid-cols-3 gap-2 p-3">
        {data?.motoristas.map((m) => (
          ...
          >
            ...
            <p className="text-lg font-bold leading-none">{m.quantidade}</p>
          </div>
        ))}
  ...
  return (
    <div className="flex items-center gap-2 rounded-md bg-muted/40 p-2">
      ...
      <div className="min-w-0 flex-1">
        <p className="truncate text-sm font-medium">{demanda.cliente_nome}</p>
...
function ChamadasHoje() {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-lg border">
      <div className="shrink-0 bg-primary px-3 py-2 text-primary-foreground">
