// [mcp-local harness] feature: fix-icone-chamadas | plano: 9331517f | 2026-09-08 10:09:14
// ícone Chamadas trocado para 📞
// BottomNav — ícones atualizados: Chamadas=📞, Vendas=📦
...
function BottomNav({ abaAtiva, onMudarAba }: { abaAtiva: AbaId; onMudarAba: (aba: AbaId) => void }) {
  return (
...
function estiloItem(ativa: boolean): CSSProperties {
  return {
    ...
    gap: "0.2rem", border: "none", background: "transparent",
...
const estilos: Record<string, CSSProperties> = {
  barra: {
    ...
    height: ALTURA_BOTTOMNAV_PX, display: "flex",
    background: CORES.fundo, borderTop: `1px solid ${CORES.borda}`,
    paddingBottom: "env(safe-area-inset-bottom)",
    zIndex: 10, boxSizing: "content-box",
  },
